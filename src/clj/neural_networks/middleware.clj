(ns neural-networks.middleware
  (:require [neural-networks.env :refer [defaults]]
            [cheshire.generate :as cheshire]
            [cognitect.transit :as transit]
            [clojure.tools.logging :as log]
            [neural-networks.layout :refer [*app-context* error-page]]
            ...
            [neural-networks.config :refer [env]]
